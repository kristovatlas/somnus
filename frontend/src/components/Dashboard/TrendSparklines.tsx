    ...
    <div className="dashboard-card" data-testid="trend-sparklines">
      ...
      <div className="sparkline-grid">
        <div className="sparkline-cell">
          ...
          <Sparkline points={scores} color="var(--color-chart-1)" label="Sleep score trend" />
        </div>
        <div className="sparkline-cell">
          <span className="sparkline-label">HRV</span>
          <Sparkline points={hrvs} color="var(--color-chart-3)" label="HRV trend" />
        </div>
        <div className="sparkline-cell">
          <span className="sparkline-label">Deep</span>
          <Sparkline points={deeps} color="var(--color-chart-2)" label="Deep sleep trend" />
        </div>
        <div className="sparkline-cell">
          <span className="sparkline-label">REM</span>
          <Sparkline points={rems} color="var(--color-chart-4)" label="REM sleep trend" />
        </div>
      </div>
    </div>
  )
