  ...
  return (
    <div className="report-card" data-testid="stage-compliance">
      ...
      <p className="report-compliance-line">
        Hit deep sleep target: {compliance.deep_target_nights}/
        {compliance.deep_total_nights} nights
      </p>
      <p className="report-compliance-line">
        Hit REM target: {compliance.rem_target_nights}/
        {compliance.rem_total_nights} nights
      </p>
    </div>
  );
}
