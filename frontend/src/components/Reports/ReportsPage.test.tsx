...
const weeklyData: WeeklyReport = {
  ...
  current: { avg_sleep_score: 84.2, avg_hrv: 43.5, avg_deep_minutes: 68.0, avg_rem_minutes: 88.0 },
  prior: { avg_sleep_score: 80.0, avg_hrv: 40.0, avg_deep_minutes: 65.0, avg_rem_minutes: 85.0 },
  trends: { sleep_score: 'up', avg_hrv: 'up', deep_minutes: 'up', rem_minutes: 'flat' },
  consistency: {
    sigma_minutes: 22,
...
const monthlyData: MonthlyReport = {
  ...
  current: { avg_sleep_score: 82.0, avg_hrv: 42.0, avg_deep_minutes: 66.0, avg_rem_minutes: 87.0 },
  prior: { avg_sleep_score: 78.0, avg_hrv: 38.0, avg_deep_minutes: 62.0, avg_rem_minutes: 84.0 },
  trends: { sleep_score: 'up', avg_hrv: 'up', deep_minutes: 'up', rem_minutes: 'flat' },
  best_night: { date: '2026-02-10', sleep_score: 95, contributing_factors: ['Exercised', 'No alcohol'] },
  worst_night: { date: '2026-02-05', sleep_score: 62, contributing_factors: ['Alcohol'] },
  stage_compliance: { deep_target_nights: 10, deep_total_nights: 15, rem_target_nights: 12, rem_total_nights: 15 },
...
describe('ReportsPage', () => {
  ...
  it('shows export link with correct href', async () => {
    ...
    await waitFor(() => {
      ...
      expect(link.getAttribute('href')).toContain('/api/reports/weekly/export-html')
    })
  })
