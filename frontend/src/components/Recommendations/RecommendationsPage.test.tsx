  ...
  recommendations: [
    {
      ...
      evidence_level: 'high',
      suggested_experiment: 'Try limiting caffeine to under 400 mg/day for 2 weeks',
      n_days: 60,
    },
    {
...
describe('RecommendationsPage', () => {
  ...
  it('shows experiment tracker when active experiment', async () => {
    ...
    expect(screen.getByText('Reducing caffeine will improve sleep score')).toBeInTheDocument()
  ...
  it('uses hedged language - no causal words', async () => {
    ...
    const pageText = screen.getByTestId('recommendations-page').textContent ?? ''
  ...
  it('TopRecommendations links to full page', async () => {
    ...
    const { TopRecommendations } = await import('../Dashboard/TopRecommendations')
