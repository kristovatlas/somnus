      ...
      {open && (
        <div className="analysis-explainer-content">
          ...
          <p>
            ...
            midnight but before 4 AM) count as 24+ too, so their correlations
            may shift slightly if you have after-midnight entries. Windows
            labeled &quot;7d&quot; are approximately the last week of recorded
            data (calendar days on the Dashboard; the last 7 recorded nights
            here).
          </p>
          <p>
