    ...
    <div className="analysis-explainer" data-testid="analysis-explainer">
      ...
      {open && (
        <div className="analysis-explainer-content">
          ...
          <p>
            <strong>p-value</strong> indicates how likely it is that the
            observed pattern occurred by chance. Lower values suggest a more
            reliable association (typically p &lt; 0.05).
          </p>
          <p>
            <strong>R²</strong> indicates how much of the variation in an
            outcome is associated with the predictors in the model. Higher is
            better, but real-world sleep data rarely exceeds 0.3-0.5.
          </p>
          <p>
