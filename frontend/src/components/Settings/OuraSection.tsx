  ...
  return (
    <section className="settings-section">
      ...
      <div className="oura-status">
        <span
          className={`oura-status-dot ${settings.oura_token_set ? "oura-status-dot--connected" : ""}`}
        />
      ...
      {syncResult && (
        <div className="oura-sync-result">
          <p>
            Synced {syncResult.synced_count} day(s) ({syncResult.start_date} to{" "}
            {syncResult.end_date})
          </p>
          {syncResult.errors.map((err, i) => (
            <p key={i} className="oura-sync-error">
              {err}
            </p>
          ))}
        </div>
