...
# ### commands auto generated by Alembic - please adjust! ###
    ...
    op.create_table('red_light_panels',
    ...
    sa.Column('caffeine_sensitivity', sa.Enum('FAST', 'NORMAL', 'SLOW', name='caffeinesensitivity'), nullable=False),
    sa.Column('timezone', sa.String(length=50), nullable=False),
    sa.Column('chronotype', sa.Enum('EARLY', 'INTERMEDIATE', 'LATE', name='chronotype'), nullable=True),
    sa.Column('zip_code', sa.String(length=10), nullable=True),
    sa.Column('age', sa.Integer(), nullable=True),
    sa.Column('display_mode', sa.Enum('CIRCADIAN', 'LIGHT', 'AUTO', name='displaymode'), nullable=False),
    sa.Column('circadian_mode_start', sa.Time(), nullable=False),
    sa.Column('onboarding_completed', sa.Boolean(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('caffeine_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('time', sa.Time(), nullable=True),
    sa.Column('amount_mg', sa.Integer(), nullable=False),
    sa.Column('source', sa.Enum('ESPRESSO', 'DRIP_COFFEE', 'COLD_BREW', 'TEA', 'ENERGY_DRINK', 'SODA', 'SUPPLEMENT', 'OTHER', name='caffeinesource'), nullable=False),
    sa.ForeignKeyConstraint(['date'], ['daily_logs.date'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('habit_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('habit_type', sa.Enum('BLUE_BLOCKERS_ON', 'SCREENS_OFF', 'EXERCISE', 'ALCOHOL', 'ROOM_TEMP_F', 'STRESS_LEVEL', 'SAUNA', 'WARM_SHOWER', name='habittype'), nullable=False),
    sa.Column('time', sa.Time(), nullable=True),
    ...
    op.create_table('nsdr_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('time', sa.Time(), nullable=True),
    sa.Column('duration_minutes', sa.Integer(), nullable=True),
    sa.Column('nsdr_type', sa.Enum('YOGA_NIDRA', 'BODY_SCAN', 'SLEEP_HYPNOSIS', 'GUIDED_RELAXATION', 'OTHER', name='nsdrtype'), nullable=False),
    sa.ForeignKeyConstraint(['date'], ['daily_logs.date'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('pre_bed_ritual_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('time', sa.Time(), nullable=True),
    sa.Column('ritual_type', sa.Enum('DEEP_BREATHING', 'LEGS_UP_WALL', 'STRETCHING', 'JOURNALING', 'READING_FICTION', 'OTHER', name='prebedritualtype'), nullable=False),
    sa.Column('duration_minutes', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['date'], ['daily_logs.date'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('red_light_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    ...
    sa.Column('duration_minutes', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['date'], ['daily_logs.date'], ),
    sa.ForeignKeyConstraint(['panel_id'], ['red_light_panels.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('sexual_activity_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('time', sa.Time(), nullable=True),
    sa.Column('activity_type', sa.Enum('PARTNERED', 'SOLO_WITH_CONTENT', 'SOLO_WITHOUT_CONTENT', name='sexualactivitytype'), nullable=False),
    sa.ForeignKeyConstraint(['date'], ['daily_logs.date'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('date', name='uq_sexual_activity_date')
    )
    op.create_table('stimulating_activity_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('end_time', sa.Time(), nullable=True),
    sa.Column('activity_type', sa.Enum('TV_MOVIES', 'VIDEO_GAMES', 'GRIPPING_AUDIOBOOK', 'OTHER', name='stimulatingactivitytype'), nullable=False),
    sa.Column('duration_minutes', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['date'], ['daily_logs.date'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('sunlight_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('start_time', sa.Time(), nullable=True),
    sa.Column('duration_minutes', sa.Integer(), nullable=True),
    ...
    op.create_table('supplement_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('time', sa.Time(), nullable=True),
    sa.Column('name', sa.String(length=100), nullable=False),
